...
class Dota2RandomHero(loader.Module):
    ...
    async def dota2hero(self, message):
        ...
        await utils.answer(
            message,
            (
                "<b><emoji document_id=5239991179226915011>ℹ</emoji> Вам выпал"
                f" герой:\n{randomhero}</b>"
            ),
        )
    ...
    async def dota2build(self, message):
        ...
        await utils.answer(
            message,
            (
                "<b><emoji document_id=5239991179226915011>ℹ</emoji> Вам выпала"
                f" сборка:\n{randombuild}</b>"
            ),
        )
    ...
    async def dota2pick(self, message):
        ...
        await utils.answer(
            message,
            (
                "<b><emoji document_id=5239991179226915011>ℹ</emoji> Вам выпали"
                f" герои:\n{randompick}\n{randompick2}\n{randompick3}\n{randompick4}\n{randompick5}</b>"
            ),
        )
