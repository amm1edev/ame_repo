...
# Author: Fl1yd
# Commands:
# .vjuh | .cowsay  | .padayu | .priletel | .huytebe
# .lol  | .fuckyou | .house  | .hello    | .coffee
# .tv   | .gren    | .bruh   | .uno      | .huy
# .imps | .f
# ---------------------------------------------------------------------------------
    ...
    async def fcmd(self, message):
        ...
        if r == 0:
            ...
            await utils.answer(
                message,
                (
                    "̫͍F̥̼F͈̫F͔̱F͓̤F̭̺F̙F͍͕F͚̩F̣̱F͖ͅF̣͙F̗͕F̦͚F̯͍ ̘͇F̰̹F̦̩F͙ͅF̙̹F̝͚"
                    " ̻F̥̙F ͙̹ ̩͔ ̘͈ ͍̭\n̹̖F̲͔F̜ ̗͎F̭̰F̰̭F̼͍F̹̞F̱͉F͓͓F̬"
                    " ̼ͅF̤͔F̦͉Fм̟̙F̦̹F͚̠FF̪̝ ̩̗F͇͓F̟̙F͎͎F͉͚ ̥̟ ̙͚\n̯̻F͓͈F̮͔F͉̫F͕̥ ͔̙ ̣"
                    " ͙г\n̞̖F̝̗F͙͓F̟͓F̖̝ ̤͙\n͔͓F̠F̖ͅF̰̹F ̠̟\n͓͕F̹͙ ̲̩F̙̠F͇̯F̖̗ ̺ ̱͔"
                    " \n̜͚F ̱̥F̥̝F̖̦F͇͔ ̜͓ ̪̹\n̩̗F̬̟F̰F̙͇F F͉̖F̼ͅF̬͔F͇͖F̞̥F̙̺F̖̮"
                    " ̥̙F̜͔F̩̜F͎̣F̲̤F̪̙FF̰̫F̝̘ ̣̻F͙͎ ̜̱ ̠͈F̬̫ ̦̩ \n͎͙F̘F͍̲"
                    " ̲ͅF͇͇F̜̥F͖͖F̪̟ ̤̩F̠̩F̬͕F̪ ̰̪F̫͍ ̺͓F͕̤F̰ͅ ̬̼F̮̼F ͎̯F͓̟F̻͔F̪F͈̭"
                    " ̠͓F̣̺ ̭F̮̩ ͖̣\n̙F͎̞F̻ F͖͔F͕̮F̯͖FF̪͕F̫͚F̣̣ ̗̣F̩"
                    " ̫͍F̥F̗̮F̻̫F͍̺F̞͉F͚̩F͕̤ ͉̤FF̼͙ ͔͕ ͉ ͙\n͍͙ F̯̬F̲̻F̥̟F̝̙ ̘\n̦̝ ͔"
                    " ̝̬F̝͍F̖͚ F̥͚F̖͉ ̩͔ \n͓̪F̝͉F̜ͅF̦ͅF͓͕ ̜̭\n͖F ͎̩F̩͕F̻͖F̯̼ ̼̼"
                    " ̹͔\n͍̱FF̹̥F̭͓F̦̺ ̖͎\n̥̜F̞͎F̖̲F̦̹F̬̘ \n̦̬F̺̭F͖̗F͕͍F̟͙ ͓͍"
                ),
            )
