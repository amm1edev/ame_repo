...
class BotsDeleterMod(loader.Module):
    ...
    strings = {
        "name": "BotsDeleter",
        "processing": (
            "<emoji document_id=5213452215527677338>⏳</emoji><b>Stopping all"
            " bots...</b>"
        ),
        "assist": (
            "<emoji document_id=5213452215527677338>⏳</emoji><b>Removing all bots from"
            " your account...</b>"
        ),
        "stop": (
            "<emoji document_id=5418063924933173277>👨‍💻</emoji><b>All bots have been"
            " successfully stopped</b>"
        ),
        "del": (
            "<emoji document_id=5418063924933173277>👨‍💻</emoji><b>All bots have been"
            " successfully removed</b>"
        ),
    }

    strings_ru = {
        "processing": (
            "<emoji document_id=5213452215527677338>⏳</emoji><b>Остановка всех"
            " ботов...</b>"
        ),
        "assist": (
            "<emoji document_id=5213452215527677338>⏳</emoji><b>Удаление всех ботов с"
            " аккаунта...</b>"
        ),
        "stop": (
            "<emoji document_id=5418063924933173277>👨‍💻</emoji><b>Все боты были успешно"
            " остановлены</b>"
        ),
        "del": (
            "<emoji document_id=5418063924933173277>👨‍💻</emoji><b>Все боты были успешно"
