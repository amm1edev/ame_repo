...
class RandomChatsMod(loader.Module):
    ...
    strings = {
        "name": "RandomChats",
        "processing": (
            "<emoji document_id=5190568934717270805>🙂</emoji><b>Uploading a chat...</b>"
        ),
        "un-iris": (
            (
        ...
        "time-err": (
            "<emoji document_id=5280821895711697516>⛔️</emoji><b>The waiting time has"
            " expired.</b> <b>Either the bot is loaded, or it's dead. Try again a"
            " little later</b>"
        ),
    }
    ...
    strings_ru = {
        "processing": (
            "<emoji document_id=5190568934717270805>🙂</emoji><b>Загрузка чата...</b>"
        ),
        "un-iris": (
            (
                "<emoji document_id=5280821895711697516>⛔️</emoji>"
        ...
        "time-err": (
            "<emoji document_id=5280821895711697516>⛔️</emoji><b>Истекло время"
            " ожидания.</b> <b>Либо бот нагружен, либо он умер. Попробуйте немного"
            " позже.</b>"
        ),
    }
    ...
    strings_uz = {
        "processing": (
            "<emoji document_id=5190568934717270805>🙂</emoji><b>Chat yuklanmoqda...</b>"
        ),
        "un-iris": (
            (
                "<emoji document_id=5280821895711697516>⛔️</emoji>"
    ...
    strings_kk = {
        "processing": (
            "<emoji document_id=5190568934717270805>🙂</emoji><b>Чатты жүктеу...</b>"
        ),
        "un-iris": (
            (
                "<emoji document_id=5280821895711697516>⛔️</emoji>"
        ...
        "time-err": (
            "<emoji document_id=5280821895711697516>⛔️</emoji><b>Күту уақыты"
            " аяқталды.</b><b>Не бот жүктелген, не ол қайтыс болды. Сәл кейінірек"
            " көріңіз.</b>"
        ),
    }
    ...
    strings_tr = {
        "processing": (
            "<emoji document_id=5190568934717270805>🙂</emoji><b>Sohbet"
            " yükleniyor...</b>"
        ),
        "un-iris": (
        ...
        "time-err": (
            "<emoji document_id=5280821895711697516>⛔️</emoji><b>zaman aşımı süresi"
            " doldu.</b><b>Ya bot yüklendi ya da öldü. Lütfen daha sonra tekrar"
            " deneyiniz.</b>"
        ),
    }
    ...
    async def rchatcmd(self, message: Message):
        ...
        async with message.client.conversation(chat) as conv:
            ...
            if response.text:
                await msg.edit(
                    "<emoji"
                    f" document_id=5190568934717270805>🙂</emoji><b>{response.text}<b>"
                )
