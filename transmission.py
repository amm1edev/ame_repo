...
class TransmissionMod(loader.Module):
    ...
    def stringTorrent(self, torrent):
        ...
        torrent_text += (
            f"{self.strings['torrent_size']}{format_size(torrent.total_size)[0]} {format_size(torrent.total_size)[1]} \n"
        )
    ...
    async def tinfocmd(self, message):
        ...
        if self.is_ready:
            ...
            string += (
                "Free space :"
                f" {format_size(free_space)[0]} {format_size(free_space)[1]}\n"
            )
            ...
            await query.answer(
                [
                    InlineQueryResultArticle(
                        ...
                        thumb_url=(
                            "https://img.icons8.com/ios-filled/128/26e07f/torrent.png"
                        ),
                        thumb_width=128,
                        thumb_height=128,
                    )
